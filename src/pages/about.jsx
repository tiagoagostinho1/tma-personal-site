...
export default function About() {
  return (
    <>
      <Head>
        <title>About - Tiago Agostinho</title>
        <meta
          name="description"
          content="I’m Tiago Agostinho. I live in Alenquer, where I build your company future."
        />
      </Head>
        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:order-first lg:row-span-2">
            <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
              I’m Tiago Agostinho. I live in Alenquer, where I build your
              company future.
            </h1>
          ...
          <div className="lg:pl-20">
            <ul role="list">
              ...
              <SocialLink
                href="https://www.linkedin.com/in/tmagostinho/"
                icon={LinkedInIcon}
                className="mt-4"
              >
                Follow on LinkedIn
              ...
              <SocialLink
                href="mailto:tiagomiguelagostinho@gmail.com"
                icon={MailIcon}
                className="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40"
              >
                tiagomiguelagostinho@gmail.com
              </SocialLink>
            </ul>
          </div>
        </div>
